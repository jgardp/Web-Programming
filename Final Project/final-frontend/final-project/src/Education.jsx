...
function Education() {
  ...
  return (
    ...
    <div className="justify-center flex bg-neutral-200 items-center pt-5 space-x-5">
      <a href="https://www.northark.edu/" target="_blank"><img className="w-20 h-20 rounded-full mb-2" src={nac} alt="logo"></img></a>
      <a href="https://www.atu.edu/" target="_blank"><img className="w-20 h-20 rounded-full mb-2" src={atu} alt="logo"></img></a>  
    </div>
